...
final readonly class ContentSnapshot
{
    ...
    public function __construct(
        ...
        /**
         * Задник доски: картинка позади глав вместе со своим местом.
         *
         * Замораживается по той же причине, что и места самих глав. Главы стоят
         * на нём в его же единицах — в оригинале пять островов лежат по ободу
         * планеты, — и живой задник рядом с замороженными главами разъехался бы
         * при первой же правке: острова повисли бы в пустоте, а сказать об этом
         * было бы некому.
         *
         * Пусто у релизов, нарезанных до появления поля, и у историй без
         * задника — доска у них пустая, какой и была.
         */
        public ?stdClass $backdrop = null,
    ) {
        $seen = [];

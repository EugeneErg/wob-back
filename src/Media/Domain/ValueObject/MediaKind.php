...
enum MediaKind: string
{
    ...
    private const MIMES = [
        ...
        'video/mp4' => 'video',
        'video/webm' => 'video',
        // Картинка с собственным ходом времени. Стоит здесь рядом с видео, а
        // не с картинками, потому что это заставка: её показывают и ждут, пока
        // она кончится, а не вешают на карту.
        //
        // Заставки чужого набора именно такие — не снятые, а собранные из
        // нескольких картинок с дорожками движения, — и переснимать их в видео
        // значило бы получить тяжёлый непрозрачный файл вместо того, что можно
        // перевести на другой язык и поправить.
        // Заставка: картинка со своим ходом времени, а звук к ней приложен
        // отдельным разделом внутри файла. Стоит рядом с видео, а не с
        // картинками, потому что её показывают и ждут конца.
        //
        // Именно картинка, а не страница: страницу пришлось бы исполнять, а
        // носители мы отдаём со своего домена и принимаем из чужих пакетов.
        'image/svg+xml' => 'video',
        'audio/ogg' => 'sound',
        'audio/mpeg' => 'sound',
        'audio/wav' => 'sound',
